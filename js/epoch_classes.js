...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function calConfig() {
		...
		self.minDate = new Date(1980,0,1);
	...
	*/
	function setLang() {
		self.daylist = new Array('Di','Lu','Ma','Me','Je','Ve','Sa','Di','Lu','Ma','Me','Je','Ve','Sa');
		self.months_sh = new Array('Jan','Fev','Mar','Avr','Mai','Jui','Jul','Aou','Sep','Oct','Nov','Dec');
		self.monthup_title = 'Aller au prochain mois';
		self.monthdn_title = 'Allez au mois précédent';
		self.clearbtn_caption = 'Reinitialiser';
		self.clearbtn_title = ' Reinitialiser les dates sélectionnés sur le calendrier';
		self.maxrange_caption = 'C\'est la valeur maximale';
		self.closebtn_caption = 'Fermer';
		self.closebtn_title = 'Fermer le calendrier';
	}
	//-----------------------------------------------------------------------------
	/**
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Janvier','Février','Mars','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre','Jan','Fev','Mar','Avr','Mai','Jui','Jul','Aou','Sep','Oct','Nov','Dec');
