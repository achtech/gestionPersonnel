...
class PDF extends FPDF
{
	...
	function LoadData()
	{
		$id_fg=$_REQUEST['facture_global'];
		$_REQUEST['ventes']=getValeurChamp('id_ventes','factures','id_facture_global',$id_fg);
		$_REQUEST['clients']=getValeurChamp('id_clients','ventes','id',$id_vente);
		$data = array();
		$data =getFactureVenteGlobal($id_fg);
	...
	function getHeaderData(){
		...
		$dta[3][0]=utf8_decode("Départ Km : ".getValeurChamp('depart_km','facture_global','id',$id_fg));
		$dta[3][1]=utf8_decode("Départ à : ".getValeurChamp('depart_date_heur','facture_global','id',$id_fg)." h ".getValeurChamp('depart_date_min','facture_global','id',$id_fg));
		$dta[4][0]=utf8_decode("Arrivée Km : ".getValeurChamp('arrivee_km','facture_global','id',$id_fg));
		$dta[4][1]=utf8_decode("Arrivée à : ".getValeurChamp('arrivee_date_heur','facture_global','id',$id_fg)." h ".getValeurChamp('arrivee_date_min','facture_global','id',$id_fg));
...
/*
	...
	$_REQUEST['ventes']=getValeurChamp('id_ventes','factures','id_facture_global',$id_fg);
	$id_client=getValeurChamp('id_clients','ventes','id',$_REQUEST['ventes']);
	$nom=getValeurChamp('nom','clients','id',$id_client);
	$pdf->SetNom($nom."_".$id_fg);
*/
	$pdf->Output();
